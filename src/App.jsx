 ...
 *
 * Replaces controls.js. Holds all UI state and wires it to the
 * imperative Cesium layer (cesiumInit.js, layers.js, diff.js).
 *
 * Pattern:
...
export default function App() {
  ...
  const [stats,       setStats]       = useState(null)   // null = not run yet
  ...
  // ── Sync visibility whenever relevant state changes ───────────────────
  useEffect(() => {
  ...
  // ── Tint A ────────────────────────────────────────────────────────────
  useEffect(() => {
    setDateATint(colorA, alphaA)
  }, [colorA, alphaA])

  // ── Tint B ────────────────────────────────────────────────────────────
  useEffect(() => {
    setDateBTint(colorB, alphaB)
  }, [colorB, alphaB])
  ...
  function handleModeChange(newMode) {
    setMode(newMode)
    // Visibility re-sync happens via the useEffect above
  }
