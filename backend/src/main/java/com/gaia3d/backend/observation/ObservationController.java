...
public class ObservationController {
    ...
    public ObservationResponse voxelize(
            @PathVariable Long observationId,
        ...
        return observationService.voxelize(observationId, safeRequest);
    }
}
